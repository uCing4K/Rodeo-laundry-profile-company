...
## 10. Frontend Static (Siap Hosting)

Halaman frontend sudah disiapkan sebagai static site di root repository.
...
- Data dinamis ditandai dengan atribut data-api pada section utama.
- Tracking form menggunakan data-api: /api/public/tracking
- Layanan menggunakan data-api: /api/public/services
- Kontak dan statistik menggunakan data-api: /api/public/settings
- FAQ menggunakan data-api: /api/public/faq

## 11. Admin Panel (Frontend Only)

Halaman admin disiapkan agar backend bisa langsung menyambungkan CRUD.

Entry point:
- admin/index.html (login)
- admin/dashboard.html (CRUD UI)
...
Setiap section admin memiliki catatan field utama di dalam UI untuk memudahkan tim backend.
